...
public class DuplicateLead extends BaseClass {
	...
	@Test(dataProvider = "fetchData", dependsOnMethods = "week5.day2assignment.CreateLead.createLead", priority = 2)
	public void duplicateLead(String emailAdd) {
...
//	9	Enter Email
		driver.findElement(By.name("emailAddress")).sendKeys(emailAdd);
